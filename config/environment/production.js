...
let files_upload_dir = path.resolve(__dirname, '..', '..')+'/import';
// Todo: Change to final PROD url
let siteURL = 'https://cde.bfast.link/';
...
module.exports = {
    ...
    sequelize: {
        //uri: 'mysql://root:root@localhost/cde',
        uri: 'mysql://cde:U1SFR05bdNCGALQi@db002.hosting.bfast-system.net/cde',
        options: {
            logging: false,
            storage: 'mysql',
            define: {
